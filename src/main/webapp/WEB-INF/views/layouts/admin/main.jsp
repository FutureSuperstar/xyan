			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue">
					...
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li><a href="${path}/admin/logout"> <i class="icon-off"></i> 退出
						</a></li>
					</ul>
				</li>
			</ul>
	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				...
				<li><a href="widgets"> <i class="icon-list-alt"></i> <span class="menu-text"> 插件 </span> </a></li>
				<li>
					<a href="calendar">
				...
				<li><a href="${path}/admin/gallery"> <i class="icon-picture"></i><span class="menu-text"> 相册 </span> </a></li>
				<li>
