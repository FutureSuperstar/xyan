								...
								<div class="step-pane" id="step2">
									<div class="row-fluid">
										...
										<div class="alert alert-info">
											...
											but it's not super important. <br />
										</div>
									</div>
								</div>
...
<script src="${path}/static/assets/js/fuelux/fuelux.wizard.min.js"></script>
<script src="${path}/static/assets/js/jquery.validate.min.js"></script>
<script src="${path}/static/assets/js/additional-methods.min.js"></script>
