...
<div class="page-header">
	<h1>
		Inbox <small> <i class="icon-double-angle-right"></i> Mailbox
			with some customizations as described in docs
		</small>
	</h1>
</div>
<!-- /.page-header -->
									...
									<div class="message-list" id="message-list">
										...
										<div class="message-item">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="Philip Markov">Philip Markov </span> <span
												class="time">Yesterday</span> <span class="attachment">
												<i class="icon-paper-clip"></i>
											</span> <span class="summary"> <span
										...
										<div class="message-item">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="Doctor Gomenz">Doctor Gomenz </span> <span
												class="time">April 5</span> <span class="summary"> <span
												class="text"> Vim te vivendo convenire, summo fuisset
											</span>
											</span>
										</div>
										...
										<div class="message-item">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="Robin Hood">Robin Hood </span> <span
										...
										<div class="message-item">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="Google Inc">Google Inc </span> <span
										...
										<div class="message-item">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="Shrek">Shrek </span> <span
		...
		<div class="hide message-content" id="id-message-content">
			<div class="message-header clearfix">
				...
				<div class="action-buttons pull-right">
					<a href="#"> <i class="icon-reply green icon-only bigger-130"></i>
					</a> <a href="#"> <i
						class="icon-mail-forward blue icon-only bigger-130"></i>
					</a> <a href="#"> <i class="icon-trash red icon-only bigger-130"></i>
					</a>
				</div>
			</div>
			...
			<div class="message-attachment clearfix">
				...
				<ul class="attachment-list pull-left list-unstyled">
					<li><a href="#" class="attached-file inline"> <i
							class="icon-file-alt bigger-110 middle"></i> <span
							class="attached-name middle">Document1.pdf</span>
					</a>

						<div class="action-buttons inline">
							<a href="#"> <i class="icon-download-alt bigger-125 blue"></i>
							</a> <a href="#"> <i class="icon-trash bigger-125 red"></i>
							</a>
						</div></li>

					<li><a href="#" class="attached-file inline"> <i
							class="icon-film bigger-110 middle"></i> <span
							class="attached-name middle">Sample.mp4</span>
					</a>
				...
				<div class="attachment-images pull-right">
					...
					<div>
						<img width="36" alt="image 4" src="${path}/static/assets/images/gallery/thumb-4.jpg" /> 
						<img width="36" alt="image 3" src="${path}/static/assets/images/gallery/thumb-3.jpg" /> 
						<img width="36" alt="image 2" src="${path}/static/assets/images/gallery/thumb-2.jpg" />
						<img width="36" alt="image 1" src="${path}/static/assets/images/gallery/thumb-1.jpg" />
					</div>
				</div>
			</div>
		</div>
