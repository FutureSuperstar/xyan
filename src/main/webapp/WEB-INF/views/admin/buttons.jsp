...
<div class="page-header">
	<h1>
		Buttons &amp; Icon <small> <i class="icon-double-angle-right"></i>
			...
			<div class="col-xs-12">
				...
				<p>
					<a href="#" class="btn btn-default btn-app radius-4"> <i
						...
						class="icon-edit bigger-230"></i> 编辑 <span
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<div>
					...
					<label class="btn btn-primary" data-toggle="button"> <i
			...
			<div class="col-sm-6">
				...
				<p>
					...
					<span class="badge badge-success">2</span> <span
						...
						class="badge badge-danger">6</span> <span class="badge badge-info">8</span>
					<span class="badge badge-purple">3</span> <span
		...
		<div class="row">
			<div class="col-xs-12">
				<h3 class="header smaller lighter blue">
					361 Scalable FontAwesome Icons <small> <a
						href="http://fontawesome.io/icons/" target="_blank"> (see all
							icons <i class="icon-external-link"></i> )
					</a>
					</small>
				</h3>
			</div>
			...
			<div class="col-xs-6 col-sm-3">
				<ul class="list-unstyled">
					...
					<li><i class="icon-folder-open-alt"></i> icon-folder-open-alt
					</li>
