...
<div class="page-header">
	<h1>
		jQuery UI <small> <i class="icon-double-angle-right"></i>
...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-calendar-empty smaller-90"></i> Datepicker
				</h3>
				<div class="row">
					<div class="col-xs-6">
			...
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-list-alt smaller-90"></i> Dialogs
				</h3>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-terminal smaller-90"></i> Autocomplete
				</h3>
				...
				<div class="row">
					<div class="col-xs-12">
						<h3 class="header blue lighter smaller">
							<i class="icon-info smaller-90"></i> Tooltip
						</h3>

						<div class="bigger-110">
							<p>
								<a class="grey" id="show-option" href="#"
									title="slide down on show"> <i class="icon-hand-right"></i>
									slide down on show
								</a>
							</p>
							...
							<p>
								<a class="blue" id="hide-option" href="#"
									title="explode on hide"> <i class="icon-hand-right"></i>
									explode on hide
								</a>
							</p>
							...
							<p>
								<a class="pink" id="open-event" href="#"
									title="move down on show"> <i class="icon-hand-right"></i>
									move down on show
								</a>
							</p>
						</div>
			...
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-reorder smaller-90"></i> Menu
				</h3>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-retweet smaller-90"></i> Spinner
				</h3>
			...
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-resize-horizontal smaller-90"></i> Slider
				</h3>

				<p>
					Please see <a href="form-elements.html">form elements page</a> for
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-list smaller-90"></i> Sortable Accordion
				</h3>
			...
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-folder-close-alt smaller-90"></i> Tabs
				</h3>
				...
				<div id="tabs">
					...
					<div id="tabs-2">
						<p>Morbi tincidunt, dui sit amet facilisis feugiat, odio metus
							...
							molestie turpis. Morbi facilisis. Curabitur ornare consequat
							nunc. Aenean vel metus. Ut posuere viverra nulla..</p>
					</div>

					<div id="tabs-3">
						<p>Mauris eleifend est et turpis. Duis id erat. Suspendisse
							potenti. Aliquam vulputate, pede vel vehicula accumsan, mi neque
							rutrum erat, eu congue orci lorem eget lorem. Praesent eu risus
							hendrerit ligula tempus pretium.</p>
					</div>
				</div>
			</div>
			<!-- ./span -->
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="header blue lighter smaller">
					<i class="icon-spinner"></i> Progressbar
				</h3>
...
<script src="${path}/static/assets/js/jquery-ui-1.10.3.full.min.js"></script>
		...
		var spinner = $("#spinner").spinner(
				{
					create : function(event, ui) {
						...
						$(this).next().addClass('btn btn-success').html(
								'<i class="icon-plus"></i>').next().addClass(
								'btn btn-danger').html(
