...
<link rel="stylesheet" href="${path}/static/assets/css/bootstrap-timepicker.css" />
<link rel="stylesheet" href="${path}/static/assets/css/daterangepicker.css" />
<link rel="stylesheet" href="${path}/static/assets/css/colorpicker.css" />
	...
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form">
				...
				<div class="col-xs-12 col-sm-4">
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div>
									<label for="form-field-mask-1"> Date <small
								...
								<hr />
								<div>
									<label for="form-field-mask-2"> Phone <small
								...
								<hr />
								<div>
									<label for="form-field-mask-3"> Product Key <small
										class="text-error">a*-999-a999</small>
									</label>
								...
								<hr />
								<div>
									<label for="form-field-mask-4"> Eye Script <small
										class="text-info">~9.99 ~9.99 999</small>
									</label>
				...
				<div class="col-xs-12 col-sm-4">
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div>
									<label for="form-field-select-1">Default</label> <select
								...
								<hr />
								<div>
									<label for="form-field-select-3">Chosen</label> <br /> <select
										class="width-80 chosen-select" id="form-field-select-3"
			...
			<h3 class="header smaller lighter blue">
				Checkboxes & Radio <small>All Checkboxes, Radios and Switch
					Buttons Are Pure CSS</small>
			</h3>
					...
					<div class="control-group">
						...
						<div class="checkbox">
							<label> <input name="form-field-checkbox" type="checkbox"
								class="ace" /> <span class="lbl"> choice 1</span>
							</label>
						</div>

						<div class="checkbox">
							<label> <input name="form-field-checkbox" type="checkbox"
								class="ace" /> <span class="lbl"> choice 2</span>
							</label>
						</div>

						<div class="checkbox">
							<label> <input name="form-field-checkbox"
								class="ace ace-checkbox-2" type="checkbox" /> <span class="lbl">
									choice 3</span>
							</label>
						</div>
					...
					<div class="control-group">
						...
						<div class="radio">
							<label> <input disabled="" name="form-field-radio"
								type="radio" class="ace" /> <span class="lbl"> disabled</span>
							</label>
						</div>
					</div>
				</div>
			...
			<hr />
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-3">On/Off
					Switches</label>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<input type="file" id="id-input-file-2" /> <input multiple=""
									type="file" id="id-input-file-3" /> <label> <input
									type="checkbox" name="file-format" id="id-file-format"
									class="ace" /> <span class="lbl"> Allow only images</span>
								</label>
							</div>
						</div>
					</div>
							...
							<div class="widget-main">
								<div class="row">
									...
									<div class="col-xs-9 col-md-10">
										<div id="eq">
											<span class="ui-slider-green">77</span> <span
												class="ui-slider-red">55</span> <span
												class="ui-slider-purple">33</span> <span
												class="ui-slider-orange">40</span> <span
												class="ui-slider-dark">88</span>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div class="input-group bootstrap-timepicker">
									<input id="timepicker1" type="text" class="form-control" /> <span
										class="input-group-addon"> <i
				...
				<div class="col-sm-4">
					<div class="widget-box">
						<div class="widget-header">
							<h4>
								<i class="icon-tint"></i> Color Picker
							</h4>
						</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<hr />
								<label for="simple-colorpicker-1">Custom Color Picker</label> <select
									id="simple-colorpicker-1" class="hide">
				...
				<div class="col-sm-4">
					<div class="widget-box">
						<div class="widget-header">
							<h4>
								<i class="icon-dashboard"></i> Knob Input
							</h4>
						</div>
										...
										<div class="col-xs-6  center">
											<div class="knob-container inline">
												<input type="text" class="input-small knob" value="41"
													...
													data-height="80" data-thickness=".2" data-fgColor="#87B87F"
		...
		<h4 class="pink">
			<i class="icon-hand-right green"></i> <a href="#modal-form"
				role="button" class="blue" data-toggle="modal"> Form Inside a
				Modal Box </a>
		</h4>
...
<script src="${path}/static/assets/js/chosen.jquery.min.js"></script>
<script src="${path}/static/assets/js/fuelux/fuelux.spinner.min.js"></script>
<script
	src="${path}/static/assets/js/date-time/bootstrap-datepicker.min.js"></script>
<script
	src="${path}/static/assets/js/date-time/bootstrap-timepicker.min.js"></script>
<script src="${path}/static/assets/js/date-time/moment.min.js"></script>
<script src="${path}/static/assets/js/date-time/daterangepicker.min.js"></script>
<script src="${path}/static/assets/js/bootstrap-colorpicker.min.js"></script>
<script src="${path}/static/assets/js/jquery.knob.min.js"></script>
<script src="${path}/static/assets/js/jquery.autosize.min.js"></script>
<script src="${path}/static/assets/js/jquery.inputlimiter.1.3.1.min.js"></script>
<script src="${path}/static/assets/js/jquery.maskedinput.min.js"></script>
<script src="${path}/static/assets/js/bootstrap-tag.min.js"></script>
				...
				.slider(
						{
							...
							slide : function(event, ui) {
								...
								$(ui.handle.firstChild).show().children().eq(1)
										.text(val);
							}
