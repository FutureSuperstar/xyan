						...
						<li class="dd-item" data-id="2">
							...
							<ol class="dd-list">
								...
								<li class="dd-item" data-id="4">
									<div class="dd-handle">
										<span class="orange">Item 4</span> <span class="lighter grey">
											&nbsp; with some description </span>
									</div>
								</li>
						...
						<li class="dd-item dd2-item" data-id="15">
							...
							<ol class="dd-list">
								...
								<li class="dd-item dd2-item" data-id="18">
									<div class="dd-handle dd2-handle">
										<i class="normal-icon icon-eye-open green bigger-130"></i> <i
											class="drag-icon icon-move bigger-125"></i>
									</div>
...
<script src="${path}/static/assets/js/jquery.nestable.min.js"></script>
