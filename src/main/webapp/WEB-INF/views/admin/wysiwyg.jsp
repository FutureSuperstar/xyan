			...
			<span class="block pull-right"> 
				...
				<span class="btn-toolbar inline middle no-margin"> 
					<span data-toggle="buttons" class="btn-group no-margin"> 
						...
						<label class="btn btn-sm btn-yellow active">2<input type="radio" value="2" /></label> 
						<label class="btn btn-sm btn-yellow"> 3 <input type="radio" value="3" /></label>
					</span>
				</span>
			</span>
		</h4>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<textarea class="span12" name="content" data-provide="markdown"
...
<script src="${path}/static/assets/js/markdown/markdown.min.js"></script>
<script src="${path}/static/assets/js/markdown/bootstrap-markdown.min.js"></script>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		}).ace_wysiwyg(
				{
					toolbar_place : function(toolbar) {
						return $(this).closest('.widget-box').find(
								'.widget-header').prepend(toolbar).children(0)
								.addClass('inline');
					},
					toolbar : [ 'bold', {
						name : 'italic',
		...
		if (typeof jQuery.ui !== 'undefined'
				&& /applewebkit/.test(navigator.userAgent.toLowerCase())) {
