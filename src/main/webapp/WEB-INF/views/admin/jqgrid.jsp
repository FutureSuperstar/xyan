...
<div class="page-header">
	<h1>
		jqGrid <small> <i class="icon-double-angle-right"></i> Dynamic
			tables and grids using jqGrid plugin
		</small>
	</h1>
</div>
<!-- /.page-header -->
...
<script src="${path}/static/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
<script src="${path}/static/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
