				...
				<div class="col-xs-12 col-sm-3 center">
					<div>
						<span class="profile-picture"> <img id="avatar"
							...
							src="${path}/static/assets/avatars/profile-pic.jpg" />
						</span>
					...
					<div class="profile-contact-info">
						<div class="profile-contact-links align-left">
							<a class="btn btn-link" href="#"> <i
								class="icon-plus-sign bigger-120 green"></i> Add as a friend
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="center">
						<a href="#" class="btn btn-sm btn-primary"> <i
							class="icon-rss bigger-150 middle"></i> <span class="bigger-110">View
								more activities</span> <i class="icon-on-right icon-arrow-right"></i>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="tabbable">
					<ul class="nav nav-tabs padding-18">
						<li class="active"><a data-toggle="tab" href="#home"> <i
								class="green icon-user bigger-120"></i> Profile
						</a></li>
								...
								<div class="col-xs-12 col-sm-9">
									...
									<div class="profile-user-info">
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<i class="icon-map-marker light-orange bigger-110"></i> <span>Netherlands</span>
												<span>Amsterdam</span>
											</div>
										</div>
						...
						<div id="feed" class="tab-pane">
							...
							<div class="center">
								<a href="#" class="btn btn-small btn-primary"> <i
									class="icon-rss bigger-150 middle"></i> View more activities <i
							...
							<div class="profile-users clearfix">
								...
								<div class="itemdiv memberdiv">
									<div class="inline position-relative">
										...
										<div class="body">
											<div class="name">
												<a href="#"> <span class="user-status status-offline"></span>
													Rose Doe
												</a>
											</div>
										</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input class="input-small" type="text"
														...
														value="Alex" /> <input class="input-small" type="text"
