							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td class="hidden-480"><span
											class="label label-warning arrowed arrowed-right">售完</span></td>
									</tr>
								</tbody>
							</table>
						</div>
									...
									<ul id="tasks" class="item-list">
										...
										<li class="item-red clearfix"><label class="inline">
											...
											<div class="pull-right action-buttons">
												...
												</a> <span class="vbar"></span> <a href="#" class="green"> <i
													class="icon-flag bigger-130"></i>
												</a>
											</div></li>
								...
								<div id="member-tab" class="tab-pane">
									<div class="clearfix">
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar" src="${staticUrl}/static/assets/avatars/user.jpg" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Joe Doe's avatar" src="${staticUrl}/static/assets/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Jim Doe's avatar" src="${staticUrl}/static/assets/avatars/avatar.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alex Doe's avatar"
													src="${staticUrl}/static/assets/avatars/avatar5.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar" src="${staticUrl}/static/assets/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Susan's avatar" src="${staticUrl}/static/assets/avatars/avatar3.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Phil Doe's avatar"
													src="${staticUrl}/static/assets/avatars/avatar4.png" />
											</div>
											...
											<div class="body">
												...
												<div class="time">
													<i class="icon-time"></i> <span class="green">2 days
														ago</span>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alexa Doe's avatar"
													src="${staticUrl}/static/assets/avatars/avatar1.png" />
											</div>
								...
								<div id="comment-tab" class="tab-pane">
									<div class="comments">
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Bob Doe's Avatar" src="${staticUrl}/static/assets/avatars/avatar.png" />
											</div>
											...
											<div class="body">
												...
												<div class="text">
													<i class="icon-quote-left"></i> Lorem ipsum dolor sit amet,
													consectetur adipiscing elit. Quisque commodo massa sed
													ipsum porttitor facilisis &hellip;
												</div>
											</div>
											...
											<div class="tools">
												<div class="inline position-relative">
													...
													<ul
														...
														<li><a href="#" class="tooltip-warning"
															data-rel="tooltip" title="Reject"> <span
																class="orange"> <i class="icon-remove bigger-110"></i>
															</span>
														</a></li>
										...
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Joe's Avatar" src="${staticUrl}/static/assets/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Rita's Avatar" src="${staticUrl}/static/assets/avatars/avatar3.png" />
											</div>
